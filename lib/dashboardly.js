        ...
        return this.query(qr)
            .then(result => {
                ...
                if(user.users_user_id === contractData.payeeId){
                    ...
                    if(!this.checkIfUserIsBlacklisted(user.users_user_id, contractData.payerId).length){
                        return this.query(
                            knex
                                .insert({
                    ...
                    if(!this.checkIfUserIsBlacklisted(user.users_user_id, contractData.payeeId).length){
                        return this.query(
                            knex
                                .insert({
